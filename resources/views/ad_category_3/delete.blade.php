    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                <p class="card-text">{{ __('You sure you want to delete') }}:{{ $ad_category_3->title }}</p>
                <form class="delete-post-form d-inline" method="POST" action="{{ route('admin.ad_category_3.destroy', ['ad_category_3'=>$ad_category_3->id]) }}" >
                    @csrf
                    @method('DELETE')
